...
# See this https://help.farbox.com/pygments.html for available styles.
# native, vim, monokai
# https://pypi.org/project/pygments-style-solarized/ ==> solarizeddark
...
htmlhelp_basename = 'Handout DGNB Seminar'
...
#      author, 'MyLittleHelpers', 'One line description of project.',
#      'Miscellaneous'),
# ]
...
# Figures
numfig = True
numfig_format = {'figure': 'Abb. %s', 'table': 'Tab. %s', 'code-block': 'Src. %s'}
